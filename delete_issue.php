                    ...
                    if (!empty($_POST['date_reported'])) {
                        if (!empty($_POST['date_assigned'])) {
                            ...
                            if ($result = mysqli_query($dbc,$query)) {
                                if ($result) {
                                    print '<div class="container"><p>Issue has been deleted from the database.</p></div>';
                                } else {
                                    print '<div class="container"><p>No rows were deleted.</p></div>';
                                }
                            } else {
                                print '<div class="container"><p>Could not delete your issue information in the database .  Error:<br>' . mysqli_error($dbc) . '.</p></div>';
                            } 
